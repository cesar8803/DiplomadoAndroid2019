...
public class LocationHandler implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        //enableLocationUpdates(); //Geolocalización proactiva ( Pide la geolocalización cada cierto tiempo)
    ...
    public void getLatLonLocation() {
        //Geolocalización de una sola vez
    ...
    private void enableLocationUpdates() {
        //Geolocalización proactiva ( Pide la geolocalización cada cierto tiempo)
